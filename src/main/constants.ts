...
export const MESSAGE_ANY_DENY: Message = issue => 'Must not be equal to ' + issue.param;
...
export const MESSAGE_ARRAY_MAX: Message = issue => 'Must have the maximum length of ' + issue.param;
export const MESSAGE_ARRAY_MIN: Message = issue => 'Must have the minimum length of ' + issue.param;
export const MESSAGE_BIGINT_MIN: Message = issue => 'Must be greater than or equal to ' + issue.param;
export const MESSAGE_BIGINT_MAX: Message = issue => 'Must be less than or equal to ' + issue.param;
export const MESSAGE_DATE_MIN: Message = issue => 'Must be after ' + issue.param;
export const MESSAGE_DATE_MAX: Message = issue => 'Must be before ' + issue.param;
...
export const MESSAGE_NUMBER_GT: Message = issue => 'Must be greater than ' + issue.param;
export const MESSAGE_NUMBER_GTE: Message = issue => 'Must be greater than or equal to ' + issue.param;
export const MESSAGE_NUMBER_LT: Message = issue => 'Must be less than ' + issue.param;
export const MESSAGE_NUMBER_LTE: Message = issue => 'Must be less than or equal to ' + issue.param;
export const MESSAGE_NUMBER_MULTIPLE_OF: Message = issue => 'Must be a multiple of ' + issue.param;
export const MESSAGE_OBJECT_ALL_KEYS: Message = issue => 'Must contain all or no keys: ' + issue.param;
export const MESSAGE_OBJECT_NOT_ALL_KEYS: Message = issue => 'Must contain not all or no keys: ' + issue.param;
export const MESSAGE_OBJECT_OR_KEYS: Message = issue => 'Must contain at least one key: ' + issue.param;
export const MESSAGE_OBJECT_XOR_KEYS: Message = issue => 'Must contain exactly one key: ' + issue.param;
export const MESSAGE_OBJECT_OXOR_KEYS: Message = issue => 'Must contain one or no keys: ' + issue.param;
export const MESSAGE_OBJECT_EXACT: Message = issue => 'Must not have unknown keys: ' + issue.param;
export const MESSAGE_OBJECT_PLAIN: Message = 'Must be a plain object';
export const MESSAGE_SET_MIN: Message = issue => 'Must have the minimum size of ' + issue.param;
export const MESSAGE_SET_MAX: Message = issue => 'Must have the maximum size of ' + issue.param;
export const MESSAGE_STRING_NON_BLANK: Message = 'Must not be blank';
export const MESSAGE_STRING_MIN: Message = issue => 'Must have the minimum length of ' + issue.param;
export const MESSAGE_STRING_MAX: Message = issue => 'Must have the maximum length of ' + issue.param;
export const MESSAGE_STRING_REGEX: Message = issue => 'Must match the pattern ' + issue.param;
export const MESSAGE_STRING_INCLUDES: Message = issue => 'Must include: ' + issue.param;
export const MESSAGE_STRING_STARTS_WITH: Message = issue => 'Must start with: ' + issue.param;
export const MESSAGE_STRING_ENDS_WITH: Message = issue => 'Must end with: ' + issue.param;
...
export const MESSAGE_TYPE_CONST: Message = issue => 'Must be equal to ' + issue.param;
export const MESSAGE_TYPE_DATE: Message = 'Must be a Date';
export const MESSAGE_TYPE_ENUM: Message = issue => 'Must be equal to one of ' + issue.param.join(', ');
...
export const MESSAGE_TYPE_TUPLE: Message = issue => 'Must be a tuple of length ' + issue.param;
