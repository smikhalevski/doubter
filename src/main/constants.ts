...
export const CODE_BIGINT_MIN = 'bigintMinValue';
export const CODE_BIGINT_MAX = 'bigintMaxValue';
export const CODE_CONST = 'const';
export const CODE_DENIED = 'denied';
export const CODE_DATE_MIN = 'dateMinValue';
export const CODE_DATE_MAX = 'dateMaxValue';
...
export const CODE_NUMBER_GT = 'numberMinValue';
export const CODE_NUMBER_LT = 'numberMaxValue';
export const CODE_NUMBER_GTE = 'numberExclusiveMinValue';
export const CODE_NUMBER_LTE = 'numberExclusiveMaxValue';
...
export const CODE_STRING_INCLUDES = 'stringIncludes';
export const CODE_STRING_STARTS_WITH = 'stringStartsWith';
export const CODE_STRING_ENDS_WITH = 'stringEndsWith';
