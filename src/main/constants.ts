...
export const CODE_ARRAY_INCLUDES = 'arrayIncludes';
export const CODE_ARRAY_MIN = 'arrayMin';
export const CODE_ARRAY_MAX = 'arrayMax';
export const CODE_BIGINT_MIN = 'bigintMin';
export const CODE_BIGINT_MAX = 'bigintMax';
export const CODE_CONST = 'const';
export const CODE_DENIED = 'denied';
export const CODE_DATE_MIN = 'dateMin';
export const CODE_DATE_MAX = 'dateMax';
...
export const CODE_NUMBER_GT = 'numberGt';
export const CODE_NUMBER_GTE = 'numberGte';
export const CODE_NUMBER_LT = 'numberLt';
export const CODE_NUMBER_LTE = 'numberLte';
export const CODE_NUMBER_MULTIPLE_OF = 'numberMultipleOf';
export const CODE_OBJECT_UNKNOWN_KEYS = 'objectUnknownKeys';
export const CODE_SET_MIN = 'setMin';
export const CODE_SET_MAX = 'setMax';
export const CODE_STRING_MIN = 'stringMin';
export const CODE_STRING_MAX = 'stringMax';
...
export const MESSAGE_OBJECT_UNKNOWN_KEYS = 'Must not have unknown keys: %s';
