...
export const MESSAGE_LITERAL = 'Must be exactly equal to %s';
export const MESSAGE_NARROWING = 'Must conform the narrowing predicate';
...
export const MESSAGE_TUPLE_LENGTH = 'Must have a length of %s';
