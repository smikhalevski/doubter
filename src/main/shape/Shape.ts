...
export class Shape<InputValue = any, OutputValue = InputValue> {
   ...
   * @see [Operations](https://megastack.dev/doubter#operations)
   */
   ...
   * @see [Checks](https://megastack.dev/doubter#checks)
   */
  check<Param>(
   ...
   * @see {@link Shape.check}
   * @see {@link Shape.refineAsync}
   * @see [Refinements](https://megastack.dev/doubter#refinements)
   */
   ...
   * @see [Alterations](https://megastack.dev/doubter#alterations)
   */
  alter<Param>(
  ...
  convert<ConvertedValue>(
     ...
     */
    cb: (value: OutputValue, options: ParseOptions) => ConvertedValue
  ...
  convertAsync<ConvertedValue>(
     ...
     * @param options Parsing options.
     */
    cb: (value: OutputValue, options: ParseOptions) => PromiseLike<ConvertedValue>
  ): Shape<InputValue, ConvertedValue> {
   ...
   *
   * @see [Advanced shapes](https://megastack.dev/doubter#advanced-shapes)
   */
...
export interface Shape<InputValue, OutputValue> {
   ...
   * @returns The {@link Ok} instance if parsing has succeeded or {@link Err} if parsing has failed.
   */
  tryAsync(input: unknown, options?: ParseOptions): Promise<Ok<OutputValue> | Err>;
  ...
  implements DeepPartialProtocol<CatchShape<DeepPartialShape<BaseShape>, FallbackValue>>
{
  ...
  constructor(
     ...
     */
    readonly fallback: FallbackValue | ((input: any, issues: Issue[], options: ParseOptions) => FallbackValue)
  ) {
    super();
