...
declare module '../core' {
  export interface NumberShape {
     ...
     *
     * @group From doubter/plugin/number-checks
     * @requires [doubter/plugin/number-checks](https://github.com/smikhalevski/doubter/modules/doubter_plugin_number_checks.html)
     */
