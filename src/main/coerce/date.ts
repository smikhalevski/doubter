import { getCanonicalValue, isArray, isValidDate } from '../internal/lang.js';
 ...
 */
export const dateCoercibleInputs: readonly unknown[] = Object.freeze([Type.ARRAY, Type.DATE, Type.STRING, Type.NUMBER]);
